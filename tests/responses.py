...
ME_RESPONSE: FLAT_RESPONSE_TYPE = ME_RESPONSE_SHORT.copy()
ME_RESPONSE.update(
    {
...
ME_RESPONSE_WITH_RELATED_DATA: NESTED_RESPONSE_TYPE = ME_RESPONSE.copy()
ME_RESPONSE_WITH_RELATED_DATA.update(
    {
        "clients": [],
        "projects": [],
        "time_entries": [],
